        ...
        <>
            <NavLink to={ href }>
                ...
                >
                    ...
                    <img src={ image } alt="plant" className="h-auto w-full relative z-20" />
                    <div className="p-5">
                        <h1 className="flex justify-center rounded-md py-2 text-principal-white duration-75 w-full text-[3rem] font-bold">
                            { name }
                        </h1>
                    </div>
                </div>
