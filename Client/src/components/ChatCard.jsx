...
const ChatCard = () => {
  return (
    <div className="col-span-12 rounded-sm border border-stroke bg-white py-6 shadow-default dark:border-strokedark dark:bg-boxdark xl:col-span-4">
      <h4 className="mb-6 px-[1.875rem] text-xl font-semibold text-black dark:text-white">
        Chats
      </h4>
      ...
      <div>
        <Link
          to="/"
          className="flex items-center gap-5 py-3 px-[1.875rem] hover:bg-gray-3 dark:hover:bg-meta-4"
        >
