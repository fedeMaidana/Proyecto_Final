...
export const Home = () => {
    return(
        <div >
            <img className="absolute w-[20rem] right-[0rem] top-[0rem] hidden lg:block" src={pattern} alt="pattern" />
            <img className="absolute w-[20rem] right-[172rem] top-[64rem] rotate-180" src={pattern} alt="pattern" />
            ...
            <div class="flex h-auto mt-32 items-center justify-center flex-wrap  px-4 gap-[5rem]">
                <NavLink to="/Customize"> {/* Shirt */}
